...
License:	GPL
Source0:	http://mirrors.ctan.org/systems/texlive/tlnet/archive/epslatex-fr.r%{version}.tar.xz
Source1:	http://mirrors.ctan.org/systems/texlive/tlnet/archive/epslatex-fr.doc.r%{version}.tar.xz
BuildArch:	noarch
